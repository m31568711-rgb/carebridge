...
Part 5 adds normalized care-journey modes, scoped appointments and schedule lists, invoice items, manual payment tracking, private payment proofs, optional international travel/accommodation/companion coordination, local or airport transport, and a role-aware journey timeline. The Accommodation and Travel/Passport update extends those same journey records with an Admin-managed accommodation catalog, atomically shared room availability, patient accommodation requests, self-arranged or CareBridge-arranged travel, and private travel documents. `LOCAL_CARE` never requires or renders flight, hotel, or passport coordination. Passport details and private copies are accepted only for CareBridge-arranged international travel and remain visible only to the patient and platform administrators.
