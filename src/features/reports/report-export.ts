...
export function buildReportHtml({
  ...
  const styles = `<style>@font-face{font-family:CareBridgeArabic;src:url('/_next/static/media/ibm-plex-sans-arabic-arabic-400-normal.woff2')}*{box-sizing:border-box}body{margin:0;color:#102a43;font-family:Inter,CareBridgeArabic,Arial,sans-serif}.carebridge-export{padding:28px;background:#fff}.carebridge-export[dir=rtl]{font-family:CareBridgeArabic,Arial,sans-serif;text-align:right}.brand{color:#164b7a;font-size:15px;font-weight:800;letter-spacing:.04em}h1{margin:10px 0 6px;font-size:24px}header p{margin:3px 0;color:#5c7083;font-size:11px}table{width:100%;border-collapse:collapse;margin-top:22px;font-size:10px}th{background:#eaf3f9;color:#102a43;text-align:start}th,td{border:1px solid #dce7ef;padding:8px;vertical-align:top}tbody tr:nth-child(even){background:#f8fafc}footer{margin-top:18px;border-top:1px solid #dce7ef;padding-top:8px;color:#708496;font-size:9px}@page{size:A4 landscape;margin:10mm}@media print{.carebridge-export{padding:0}thead{display:table-header-group}tr{break-inside:avoid}}</style>`;
