...
export const adminModuleKeys = [
  ...
  'doctor_languages', 'doctor_hospitals', 'pharmacies', 'provider_documents', 'provider_accreditations',
] as const;
