...
const en = {
  ...
  navigation: {
    ...
    documents: 'Provider documents', accreditations: 'Accreditations', audit: 'Audit logs', bulkImport: 'Bulk import',
  },
  common: {
    ...
    noResults: 'No matching records', noResultsDescription: 'Adjust the filters or add the first record.', configured: 'Administration ready',
    ...
    formDescription: 'Required fields are marked. Authorized changes are recorded for accountability.',
    openMenu: 'Open administration navigation', closeMenu: 'Close navigation', profile: 'Administrator account', backHome: 'Public website',
    configurationTitle: 'Administration is temporarily unavailable',
    configurationDescription: 'The public site remains available while the protected administration connection is restored.',
    configurationAction: 'Review setup guide', informationalPrice: 'Informational starting price only — not a treatment quote.',
    chooseFile: 'Choose file', uploading: 'Uploading…', uploadInvalid: 'File type or size is not allowed.', uploadUnavailable: 'Secure uploads are temporarily unavailable.',
    uploadProviderFirst: 'Save or select the provider before uploading.', uploadFailed: 'Upload failed. Check your Storage permissions and try again.', fileAttached: 'Secure file attached',
  },
  dashboard: {
    eyebrow: 'Master data overview', title: 'A clear view of the provider network',
    description: 'Monitor the provider network, active markets, specialties, and verification workload.',
    ...
    verified: 'Verified providers', awaiting: 'Awaiting verification', countries: 'Active countries', treatmentJourneys:'Treatment journeys', journeyBreakdown:'Journey status overview', activeJourneys:'Active', planningJourneys:'Planning', completedJourneys:'Completed', providersByType: 'Providers by type',
...
const fr = {
  ...
  navigation: { overview:'Vue d’ensemble',geography:'Géographie',countries:'Pays',cities:'Villes',clinical:'Catalogue clinique',specialties:'Spécialités',treatments:'Traitements',providers:'Prestataires',hospitals:'Hôpitaux',branches:'Sites hospitaliers',hospitalSpecialties:'Spécialités des hôpitaux',hospitalTreatments:'Traitements des hôpitaux',doctors:'Médecins',doctorSpecialties:'Spécialités des médecins',doctorLanguages:'Langues des médecins',doctorHospitals:'Médecins et hôpitaux',pharmacies:'Pharmacies',governance:'Gouvernance',documents:'Documents prestataires',accreditations:'Accréditations',audit:'Journaux d’audit',bulkImport:'Import en masse' },
  common: { ...en.common, add:'Ajouter',edit:'Modifier',delete:'Supprimer',deleteConfirm:'Supprimer cet enregistrement ? Cette action est irréversible.',save:'Enregistrer',saving:'Enregistrement…',cancel:'Annuler',search:'Rechercher',filter:'Filtrer',all:'Tous',active:'Actif',inactive:'Inactif',activate:'Activer',deactivate:'Désactiver',actions:'Actions',status:'Statut',verification:'Vérification',previous:'Précédent',next:'Suivant',page:'Page',of:'sur',records:'enregistrements',noResults:'Aucun résultat',noResultsDescription:'Modifiez les filtres ou ajoutez le premier enregistrement.',configured:'Administration prête',saved:'Enregistrement sauvegardé.',updated:'Statut mis à jour.',failed:'Impossible d’enregistrer. Vérifiez les champs et vos autorisations.',required:'Obligatoire',optional:'Facultatif',clear:'Effacer les filtres',createTitle:'Créer un enregistrement',editTitle:'Modifier l’enregistrement',formDescription:'Les champs obligatoires sont signalés. Les changements autorisés sont consignés.',openMenu:'Ouvrir la navigation',closeMenu:'Fermer la navigation',profile:'Compte administrateur',backHome:'Site public',configurationTitle:'L’administration est momentanément indisponible',configurationDescription:'Le site public reste disponible pendant le rétablissement de la connexion sécurisée.',configurationAction:'Consulter le guide',informationalPrice:'Prix de départ indicatif uniquement — il ne constitue pas un devis.',chooseFile:'Choisir un fichier',uploading:'Téléversement…',uploadInvalid:'Le type ou la taille du fichier n’est pas autorisé.',uploadUnavailable:'Les téléversements sécurisés sont momentanément indisponibles.',uploadProviderFirst:'Enregistrez ou sélectionnez le prestataire avant le téléversement.',uploadFailed:'Échec du téléversement. Vérifiez vos autorisations puis réessayez.',fileAttached:'Fichier sécurisé joint' },
  dashboard: { ...en.dashboard, eyebrow:'Vue des données de référence',title:'Une vision claire du réseau de soins',description:'Suivez le réseau de soins, les marchés actifs, les spécialités et les vérifications en attente.',hospitals:'Hôpitaux',doctors:'Médecins',pharmacies:'Pharmacies',specialties:'Spécialités',verified:'Prestataires vérifiés',awaiting:'En attente de vérification',countries:'Pays actifs',treatmentJourneys:'Parcours de soins',journeyBreakdown:'Vue des parcours',activeJourneys:'Actifs',planningJourneys:'En préparation',completedJourneys:'Terminés',providersByType:'Prestataires par type',verificationDistribution:'Répartition des vérifications',databaseUnavailable:'Les données sont temporairement indisponibles.' },
  modules: {
...
const ar = {
  ...en,
  title: 'إدارة المنصة', subtitle: 'إدارة البيانات المرجعية والمنشآت الطبية والاعتمادات وسجل التدقيق.',
  navigation: { overview:'نظرة عامة',geography:'المواقع',countries:'الدول',cities:'المدن',clinical:'الدليل الطبي',specialties:'التخصصات',treatments:'العلاجات',providers:'المنشآت الطبية',hospitals:'المستشفيات',branches:'فروع المستشفيات',hospitalSpecialties:'تخصصات المستشفيات',hospitalTreatments:'خدمات المستشفيات',doctors:'الأطباء',doctorSpecialties:'تخصصات الأطباء',doctorLanguages:'لغات الأطباء',doctorHospitals:'ارتباط الأطباء بالمستشفيات',pharmacies:'الصيدليات',governance:'الحوكمة والاعتماد',documents:'وثائق المنشآت',accreditations:'الاعتمادات',audit:'سجل التدقيق',bulkImport:'الاستيراد الجماعي' },
  common: { ...en.common, add:'إضافة سجل',edit:'تعديل',delete:'حذف',deleteConfirm:'هل تريد حذف هذا السجل؟ لا يمكن التراجع عن هذا الإجراء.',save:'حفظ السجل',saving:'جارٍ الحفظ…',cancel:'إلغاء',search:'بحث',filter:'تصفية',all:'الكل',active:'نشط',inactive:'غير نشط',activate:'تفعيل',deactivate:'إيقاف',actions:'الإجراءات',status:'الحالة',verification:'التحقق',previous:'السابق',next:'التالي',page:'صفحة',of:'من',records:'سجل',noResults:'لا توجد نتائج مطابقة',noResultsDescription:'غيّر عوامل التصفية أو أضف السجل الأول.',configured:'لوحة الإدارة جاهزة',saved:'تم حفظ السجل بنجاح.',updated:'تم تحديث الحالة بنجاح.',failed:'تعذر حفظ السجل. راجع الحقول والصلاحيات.',required:'مطلوب',optional:'اختياري',clear:'مسح التصفية',createTitle:'إنشاء سجل',editTitle:'تعديل السجل',formDescription:'الحقول المطلوبة موضحة، وتُسجّل جميع التغييرات المصرح بها لضمان المساءلة.',openMenu:'فتح قائمة الإدارة',closeMenu:'إغلاق القائمة',profile:'حساب المسؤول',backHome:'الموقع العام',configurationTitle:'لوحة الإدارة غير متاحة مؤقتًا',configurationDescription:'يبقى الموقع العام متاحًا إلى حين استعادة الاتصال الآمن بلوحة الإدارة.',configurationAction:'مراجعة دليل الإعداد',informationalPrice:'سعر ابتدائي استرشادي فقط — وليس عرض سعر علاجي.',chooseFile:'اختيار ملف',uploading:'جارٍ الرفع…',uploadInvalid:'نوع الملف أو حجمه غير مسموح.',uploadUnavailable:'رفع الملفات الآمن غير متاح مؤقتًا.',uploadProviderFirst:'احفظ المنشأة الطبية أو حددها قبل رفع الملف.',uploadFailed:'تعذر رفع الملف. راجع صلاحياتك ثم حاول مرة أخرى.',fileAttached:'تم إرفاق الملف الآمن' },
  dashboard: { ...en.dashboard, eyebrow:'نظرة عامة',title:'شبكة الرعاية في لمحة',description:'تابع المنشآت الطبية والتخصصات والأسواق النشطة وطلبات الاعتماد.',hospitals:'المستشفيات',doctors:'الأطباء',pharmacies:'الصيدليات',specialties:'التخصصات',verified:'منشآت معتمدة',awaiting:'بانتظار المراجعة',countries:'الدول النشطة',treatmentJourneys:'رحلات العلاج',journeyBreakdown:'ملخص حالات الرحلات',activeJourneys:'نشطة',planningJourneys:'قيد التخطيط',completedJourneys:'مكتملة',providersByType:'شبكة الرعاية حسب النوع',verificationDistribution:'حالات الاعتماد',databaseUnavailable:'تعذر تحميل مؤشرات لوحة التحكم مؤقتًا.' },
  modules: {
