    ...
    <div className="min-h-screen bg-white text-slate-950">
      ...
      <main id="main-content">
        ...
        <section className="px-5 pb-20 sm:px-8 lg:pb-28">
          <div className="mx-auto max-w-7xl overflow-hidden rounded-[2rem] bg-blue-600 px-6 py-12 text-center text-white shadow-2xl shadow-blue-600/20 sm:px-10 lg:py-16"><p className="text-xs font-bold uppercase tracking-[0.16em] text-blue-100">{landing.cta.eyebrow}</p><h2 className="mx-auto mt-5 max-w-3xl text-3xl font-semibold tracking-[-0.035em] sm:text-5xl">{landing.cta.title}</h2><p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-blue-100">{landing.cta.description}</p><div className="mt-8 flex justify-center"><Link className="inline-flex min-h-12 items-center justify-center rounded-xl bg-white px-6 text-sm font-semibold text-blue-700" href={`/${locale}/login`}>{landing.cta.secondaryAction}</Link></div><div className="mt-7 flex justify-center"><InstallApp copy={dictionary.install} /></div></div>
        </section>
      </main>
